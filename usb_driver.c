...
//usb_device_id is a table type which stores all the devices supported by driver
static struct usb_device_id skel_table[] = {
    {USB_DEVICE(0x0781, 0x5567)}, //USB_DEVICE is MACRO to define usb with vendor ID and Product ID of USB
    {}};
